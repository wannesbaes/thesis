...
\begin{figure}[htb!]
    ...
    \end{subfigure}
    \caption[Channel decomposistion of a \acs*{MU}-\acs*{MIMO} system]{A block diagram of the original \acs*{MU}-\acs*{MIMO} channel (a) and its decomposition into parallel Gaussian \acs*{SISO} subchannels (b), as achieved by the \acs*{ZF}--type precoding techniques.}
