...
Note that this specific approach relies on the fact that the set of candidate streams is finite and therefore does not extend in the same form to waterfilling algorithms for, e.g., power allocation across the frequency spectrum of a frequency-selective channel.
