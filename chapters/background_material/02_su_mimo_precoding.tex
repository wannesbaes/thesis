...
Now define the transformed variables $\tilde{\mathbf{y}} = \mathbf{U}^{\mathsf{H}} \mathbf{y}$, $\tilde{\mathbf{x}} = \mathbf{V}^{\mathsf{H}} \mathbf{x}$, and $\tilde{\mathbf{n}} = \mathbf{U}^{\mathsf{H}} \mathbf{n}$.
