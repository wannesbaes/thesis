...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/satellite_communications_precoding/05_hts_communication_systems/multibeam_satcom_annotated_big.png}
...
While the works above tackle the same regime of outdated \ac{CSI} in mobile multi-beam satellite systems, our approach differs in ...
