...
In this appendix, we solve the problem of optimal power allocation across independent scalar Gaussian channels using the method of Lagrange multipliers.
...
% ===========================================================
%  Optimal Power Allocation using Lagrange Multipliers
% =========================================================== 
...
To solve the constrained optimization problem in~\eqref{eq:optimal_power_allocation_optimization_problem}, the method of Lagrange multipliers is employed.
...
\begin{figure}[!htbp]
    ...
    \caption[Waterfilling algorithm interpretation]{A visualization of the waterfilling algorithm as the optimal power allocation strategy in a system with $N = 4$ channels.}
...
% Example 1: piecewise frequency selective channel
